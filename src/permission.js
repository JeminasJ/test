...
NProgress.configure({ showSpinner: false }) // 顶部进度条 不显示旋转加载

const allowList = ['login', 'register', 'registerResult'] // 免登录白名单
const loginRoutePath = '/user/login' // 登录路由地址
const defaultRoutePath = '/dashboard/workplace' // 默认路由首页
